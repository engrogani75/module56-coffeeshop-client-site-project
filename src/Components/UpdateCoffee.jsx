...
const updateCoffeeHandle = (event) =>{
    ...
    const updateCoffee = {_id, name, quantity, supplier, taste, category, details, photo }
    ...
    return (
        <div>
           ...
           <div className="bg-[#F4F3F0] p-24">
            <h2 className="text-3xl font-extrabold">Pls update your coffee</h2>
            <form onSubmit={updateCoffeeHandle}>
                ...
                <input type="submit" value="Update Coffee Coffee" className="btn btn-block" />
